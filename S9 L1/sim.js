...
class User {
    ...
    ricarica(ammontare) {
        ...
        console.log(`Sono tati ricaricati: ${ammontare}€.   Il tuo credito attuale è: ${this.credito}€`);
        return this.credito;
    }
    ...
    chiamata(minuti) {
        ...
        if (this.credito >= costoChiamata) {
            ...
            console.log(`Chiamata di ${minuti} minuti effettuata. Costo: ${costoChiamata}€. Credito rimanente: ${this.credito}€  Totale Chiamate: ${this.numeroChiamate} minuti`);
        }
        else {
    ...
    getNumeroChiamate() {
        console.log(`Numero di minuti passati in chiamata: ${this.numeroChiamate}`);
